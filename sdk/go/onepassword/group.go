...
func NewGroup(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("onepassword:index/group:Group", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetGroup(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("onepassword:index/group:Group", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Group{s: s}, nil
