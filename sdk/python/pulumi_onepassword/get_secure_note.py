...
class GetSecureNoteResult:
    ...
    """
    def __init__(__self__, name=None, notes=None, sections=None, tags=None, vault=None, id=None):
...
def get_secure_note(name=None,notes=None,sections=None,tags=None,vault=None,opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('onepassword:index/getSecureNote:getSecureNote', __args__, opts=opts).value
