...
class Login(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, notes=None, password=None, sections=None, tags=None, url=None, username=None, vault=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, name=None, notes=None, password=None, sections=None, tags=None, url=None, username=None, vault=None):
        """
