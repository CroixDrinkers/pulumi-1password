...
class Document(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, content=None, file_path=None, name=None, tags=None, vault=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, content=None, file_path=None, name=None, tags=None, vault=None):
        """
