...
def get_software_license(main=None,name=None,notes=None,sections=None,tags=None,vault=None,opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('onepassword:index/getSoftwareLicense:getSoftwareLicense', __args__, opts=opts).value
