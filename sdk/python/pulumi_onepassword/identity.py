...
class Identity(pulumi.CustomResource):
    address: pulumi.Output[dict]
    identification: pulumi.Output[dict]
    internet: pulumi.Output[dict]
    name: pulumi.Output[str]
    notes: pulumi.Output[str]
    sections: pulumi.Output[list]
    tags: pulumi.Output[list]
    vault: pulumi.Output[str]
    def __init__(__self__, resource_name, opts=None, address=None, identification=None, internet=None, name=None, notes=None, sections=None, tags=None, vault=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        The **address** object supports the following:
          ...
          * `businessPhone` (`pulumi.Input[str]`)
          * `cellPhone` (`pulumi.Input[str]`)
          * `defaultPhone` (`pulumi.Input[str]`)
          ...
          * `homePhone` (`pulumi.Input[str]`)
          * `title` (`pulumi.Input[str]`)
        
        The **identification** object supports the following:
        
          * `birthDate` (`pulumi.Input[float]`)
          * `company` (`pulumi.Input[str]`)
          * `department` (`pulumi.Input[str]`)
          * `fields` (`pulumi.Input[list]`)
          ...
          * `initial` (`pulumi.Input[str]`)
          * `jobTitle` (`pulumi.Input[str]`)
          * `lastname` (`pulumi.Input[str]`)
          * `occupation` (`pulumi.Input[str]`)
          * `sex` (`pulumi.Input[str]`)
          * `title` (`pulumi.Input[str]`)
        ...
        if opts.id is None:
            ...
            __props__['identification'] = identification
    ...
    @staticmethod
    def get(resource_name, id, opts=None, address=None, identification=None, internet=None, name=None, notes=None, sections=None, tags=None, vault=None):
        """
