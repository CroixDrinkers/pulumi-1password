...
export class CreditCard extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CreditCardState, opts?: pulumi.CustomResourceOptions): CreditCard {
        return new CreditCard(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'onepassword:index/creditCard:CreditCard';
    ...
    public readonly main!: pulumi.Output<outputs.CreditCardMain | undefined>;
    public readonly name!: pulumi.Output<string>;
    public readonly notes!: pulumi.Output<string | undefined>;
    public readonly sections!: pulumi.Output<outputs.CreditCardSection[] | undefined>;
    ...
    constructor(name: string, argsOrState?: CreditCardArgs | CreditCardState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as CreditCardState | undefined;
            ...
            const args = argsOrState as CreditCardArgs | undefined;
        ...
        super(CreditCard.__pulumiType, name, inputs, opts);
    }
}
...
export interface CreditCardState {
    readonly main?: pulumi.Input<inputs.CreditCardMain>;
    readonly name?: pulumi.Input<string>;
    readonly notes?: pulumi.Input<string>;
    readonly sections?: pulumi.Input<pulumi.Input<inputs.CreditCardSection>[]>;
